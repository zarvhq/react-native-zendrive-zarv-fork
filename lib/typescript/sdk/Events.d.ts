import { DriveStartInfo, DriveResumeInfo, EstimatedDriveInfo, AnalyzedDriveInfo, AccidentInfo } from './Infos';
export declare enum ZendriveCallbackEventKind {
...
export type ZendriveCallbackEvent = ZendriveOnDriveStartEvent | ZendriveOnDriveResumeEvent | ZendriveOnDriveEndEvent | ZendriveOnDriveAnalyzedEvent | ZendriveOnAccidentEvent | ZendriveOnPotentialAccidentEvent | ZendriveOnSettingsChangedEvent | ZendriveOnLocationApprovedEvent | ZendriveOnLocationDeniedEvent | ZendriveOnActivityApprovedEvent | ZendriveOnActivityDeniedEvent | ZendriveOnBootCompleted | ZendriveOnMyPackageReplaced;
export type ZendriveCallbackEventHandler = (event: ZendriveCallbackEvent) => void;
