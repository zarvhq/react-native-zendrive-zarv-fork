 ...
 */
export type GooglePlayConnectionError = GooglePlayConnectionResult & ZendriveSettingError;
 ...
 * error that occurred when attempting to connect to google play services.
 */
export type GooglePlaySettingsError = GooglePlaySettingsResult & ZendriveSettingError;
/**
 * The type of a [[ZendriveSettingError]] or [[ZendriveSettingWarning]]
 */
export declare enum ZendriveIssueType {
    /**
 ...
 */
export declare enum ZendriveErrorCode {
    /**
 ...
 */
export declare enum ZendriveVehicleTaggingErrorCode {
